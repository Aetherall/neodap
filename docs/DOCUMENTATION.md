...
│   ├── (rooter.nvim)                # VS Code workspace parser (external dependency)
...
| `cursor_focus` | *(reactive)* | Automatic focus management |
...
| `rooter` | *(integration)* | VS Code launch.json support (via rooter.nvim) |
