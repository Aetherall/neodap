...
M.schema = {
  ...
  Config = {
    ...
    superseded = "bool",           -- true when a newer Config with same name exists
    isCompound = "bool",
    ...
    __indexes = {
      ...
      { name = "by_superseded", fields = { { name = "superseded" } } },
    },
  },
  ...
  Session = {
    ...
    allOutputs = {
      ...
      __indexes = {
        ...
        { name = "by_visible_matched_globalSeq_asc", fields = { { name = "visible" }, { name = "matched" }, { name = "globalSeq", dir = "asc" } } },
      }
    },
  ...
  Output = {
    ...
    column = "number",
    variablesReference = "number",
    repeatCount = "number",  -- 1 by default, incremented for consecutive identical messages
