...
T.Scenario(function(api)
  ...
  T.sleep(300)
  T.TerminalSnapshot('cursor_simple_scopes')

  -- Expand Local scope completely
  T.cmd("normal! l") -- Expand Local scope
  T.sleep(500)
  T.TerminalSnapshot('cursor_simple_expanded')

  -- Navigate to see where variables appear
  T.cmd("normal! j")
  T.TerminalSnapshot('cursor_simple_first_var')

  -- Close popup
  T.cmd("normal! q")
end)

--[[ TERMINAL SNAPSHOT: cursor_simple_scopes
Size: 24x80
...
--[[ TERMINAL SNAPSHOT: cursor_simple_expanded
Size: 24x80
...
--[[ TERMINAL SNAPSHOT: cursor_simple_first_var
Size: 24x80
