...
T.Scenario(function(api)
  ...
  -- Test the tree functionality (which demonstrates asNode caching)
  T.cmd("Variables4Tree")
  T.sleep(500)
  T.TerminalSnapshot('variables4_tree_demonstration')

  -- Close the tree popup
  T.cmd("execute \"normal q\"")
  T.sleep(200)
  T.TerminalSnapshot('variables4_tree_closed')
end)
...
--[[ TERMINAL SNAPSHOT: variables4_tree_demonstration
Size: 24x80
Cursor: [7, 0] (line 7, col 0)
Mode: n
...
--[[ TERMINAL SNAPSHOT: variables4_tree_closed
Size: 24x80
Cursor: [7, 0] (line 7, col 0)
Mode: n
