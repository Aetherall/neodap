  ...
  entity_buffer.register("dap://source", "Source", "one", {
    ...
    setup = function(bufnr, source, options)
      ...
      a.run(function()
        ...
        -- Re-trigger BufReadPost so plugins (frame_highlights, breakpoint_signs,
        -- etc.) can set up extmarks at the correct line positions now that
        -- the real content is loaded (they may have been clamped to line 0
        -- when the buffer only had "-- Loading...").
        vim.b[bufnr].neodap_frame_highlights = nil
