    ...
    scoped.withScope(buffer_scope, function()
      source.activeFrames:each(function(frame)
        ...
        local function update()
          ...
          -- When the DAP column is past the end of the line (e.g., return-value
          -- intermediate stops in V8), fall back to highlighting the full line
          -- so the frame context color is always visible.
