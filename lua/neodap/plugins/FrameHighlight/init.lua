...
local FrameHighlight = BasePlugin:extend()
...
function FrameHighlight.plugin(api)
  return BasePlugin.createPlugin(api, FrameHighlight, {
...
function FrameHighlight:setupAutocommands()
  ...
  vim.api.nvim_set_hl(0, self.top_frame_hl_group, {
    default = true,
    bg = "#FF8C00", -- Orange background for top frame
    blend = 90,
  })

  vim.api.nvim_set_hl(0, self.other_frame_hl_group, {
    default = true,
