...
function M.setup(opts)
  ...
  use(neodap.plugins.rooter, "rooter")
  ...
  use(neodap.plugins.open_cmd, "open_cmd", {
    dap_log_dir = (opts.plugins.dap_log or {}).log_dir or "/tmp/neodap-dap",
  })
